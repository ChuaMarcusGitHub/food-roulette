...
const inputVariants = cva(base, {
  variants: {
    intent: {
      default:
        "border-slate-200 focus:ring-2 focus:ring-teal-600 dark:border-slate-600",
      error:
        "border-red-400 focus:ring-2 focus:ring-red-500 dark:border-red-600",
      mono: "border-slate-200 font-mono tracking-widest focus:ring-2 focus:ring-teal-600 dark:border-slate-600",
    },
  },
  defaultVariants: {
    intent: "default",
